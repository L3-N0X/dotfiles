...
terminal =
"~/.config/hypr/hyprland/scripts/launch_first_available.sh 'kitty -1' 'alacritty' 'wezterm' 'foot' 'konsole' 'kgx' 'uxterm' 'xterm'"
fileManager =
"~/.config/hypr/hyprland/scripts/launch_first_available.sh 'dolphin' 'nautilus' 'nemo' 'thunar' 'kitty -1 fish -c yazi'"
browser =
"~/.config/hypr/hyprland/scripts/launch_first_available.sh 'helium-browser' 'google-chrome-stable' 'zen-browser' 'firefox' 'brave' 'chromium' 'opera' 'librewolf'"
codeEditor =
"~/.config/hypr/hyprland/scripts/launch_first_available.sh 'code' 'windsurf' 'antigravity' 'codium' 'cursor' 'zed' 'zedit' 'zeditor' 'kate' 'gnome-text-editor' 'emacs' 'command -v nvim && kitty -1 nvim' 'command -v micro && kitty -1 micro'"
officeSoftware =
