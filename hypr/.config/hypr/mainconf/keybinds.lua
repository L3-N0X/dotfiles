...
-- Add this somewhere in your hyprland.lua
hl.device({
...
-- Screenshot bindings for flameshot
-- hl.bind(mainMod .. " + S",
--     hl.dsp.exec_cmd(
--         "grim -g \"$(slurp)\" - | satty --filename - --output-filename ~/Pictures/Screenshots/Screenshot_%Y-%m-%d_%H-%M-%S.png --copy-command wl-copy"))
